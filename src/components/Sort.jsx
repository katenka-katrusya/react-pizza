...
export const Sort = ({ value, onClickSortType, onClickOrder }) => {
      ...
      <div className='sort__label'>
        ...
        <button onClick={chooseOrder} className='sort__button-arrows'>
          <svg className='sort-arrows'
            ...
            <g>
              <path fill='none' id="arrow1" className={!isAscending ? 'active' : ''}
              ...
              <path fill='none' id="arrow2" className={isAscending ? 'active' : ''}
          ...
          <ul>
            {sortList.map((sortObj, index) => (
              <li onClick={() => chooseActiveSort(sortObj)}
                  className={value.sortProperty === sortObj.sortProperty ? 'active' : ''}
                  key={index}>
                {sortObj.name}
              </li>
            ))}
